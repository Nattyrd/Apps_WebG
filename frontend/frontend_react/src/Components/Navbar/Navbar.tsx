...
const Container = styled.div<any>`
  ...
  width: 100vw;
  top: 0;
  border-bottom: 2px solid ${(props: any) => props.theme.border};
`
...
const Left = styled.div`
  ...
  align-items: center;
`
const SearchContainer = styled.form<any>`
...
const Logo = styled.p<any>`
  ...
  color: ${(props: any) => props.theme.text};
`
const LogoMirror = styled.p<any>`
  position: absolute;
  cursor: pointer;
  letter-spacing: 6px;
  transform: scale(1, -1) translateY(-67%);
  font-size: 2.2em;
  ${(props: any) => props.theme.gradient};
